    ...
    return (
        <div className='flex flex-col items-center h-screen'>
            <div className='flex pt-10'>
                <img src='/app/그림4.png' className=' h-40'/>
            </div>
            <div className='flex text-5xl pt-4 pb-7'>{formattedDate}</div>
            <div className='flex w-auto items-center justify-center'>
                <p className='flex text-white pb-1 bg-[#FF5500] text-7xl font-black'>{data[0]}</p>
            </div>
            <div className='flex flex-col justify-center items-center h-96'>
                <div className=' grid-cols-2 grid w-full place-items-stretch'>
                    <div>
                        <p className='flex font-medium text-7xl pt-8 pl-10 pr-10 pb-3 justify-center'>내가 살때</p>
                ...
                <div className=' grid-cols-2 grid w-full justify-items-center'>
                    <div>
                        <div className={`flex font-medium p-6 justify-center pl-14 ${data[1]==0 ? "text-5xl" : "text-7xl"}`}>{data[1]==0 ? "제품시세적용" : new Intl.NumberFormat('ko-KR', { style: 'decimal' }).format(data[1]) +"원"}</div>
                    ...
                    <div>
                        <div className={`flex font-medium p-6 justify-center pl-14 ${data[2]==0 ? "text-5xl" : "text-7xl"}`}>{data[2]==0 ? "제품시세적용" : new Intl.NumberFormat('ko-KR', { style: 'decimal' }).format(data[2]) +"원"}</div>
